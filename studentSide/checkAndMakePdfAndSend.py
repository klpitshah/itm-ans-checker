...
# ARGS = [
#     'python3',
#     './checkAndMakePdfAndSend.py',
#     '1',
#     '160950107071',
#     '2016',
#     '44444',
#     [ 'sdcsdcsdc:/5762*', 'ververververv:/5762*' ],
#     [ 'SDSDVSDVSDV:/5762*', 'NKSJDNCJSNDCISDC:/5762*' ],
#     20200204,
#     '01',
#     '01'
#   ]
...
branchCode = str(sys.argv[8])
streamCode = str(sys.argv[9])
...
loaded_model = pickle.load(open('ans_checker_{}_{}_{}_{}.sav'.format(course, batch,streamCode+branchCode, examNo), 'rb'))

print('ans_checker_{}_{}_{}_{}.sav'.format(course, batch,streamCode+branchCode, examNo))
...
pdf.cell(epw, 0.0, 'GTU eResult', align='C')
...
pdf.ln(1.5*pdf.font_size)
pdf.cell(epw, 0.0, 'Email : ' + username +'gtu@gmail.com', align='L')
pdf.ln(1.5*pdf.font_size)
pdf.cell(epw, 0.0, 'Batch : '+ batch, align='L')
pdf.ln(1.5*pdf.font_size)
pdf.cell(epw, 0.0, 'Stream Code : ' + streamCode, align='L')
pdf.ln(1.5*pdf.font_size)
pdf.cell(epw, 0.0, 'Branch Code : ' + branchCode, align='L')
pdf.ln(1.5*pdf.font_size)
